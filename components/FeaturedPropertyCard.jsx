    ...
    return (
        <div
            ...
            <div className="p-6">
                ...
                >
                    {property.rates.nightly && <p><FaMoneyBill className="inline" />  Nightly</p>}
                    {property.rates.weekly && <p><FaMoneyBill className="inline" /> Weekly</p>}
                    {property.rates.monthly && <p><FaMoneyBill className="inline" /> Monthly</p>}
                </div>
